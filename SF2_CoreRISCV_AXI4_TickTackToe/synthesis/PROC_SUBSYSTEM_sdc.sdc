# Written by Synplify Pro version map201609actrcp1, Build 005R. Synopsys Run ID: sid1512668824 
...
create_clock -period 60.606 -waveform {0.000 30.303} -name {MSS_SUBSYSTEM_sb_0/MSS_SUBSYSTEM_sb_MSS_0/CLK_CONFIG_APB} [get_pins {MSS_SUBSYSTEM_sb_0/MSS_SUBSYSTEM_sb_MSS_0/MSS_ADLIB_INST:CLK_CONFIG_APB}] 
create_clock -period 10.000 -waveform {0.000 5.000} -name {spi_chanctrl_Z19|un5_resetn_rx_inferred_clock} [get_pins {CORESPI_1/USPI/UCC/un5_resetn_rx:Y}] 
...
# Generated Clocks 
create_generated_clock -name {MSS_SUBSYSTEM_sb_0/CCC_0/GL0} -multiply_by {33} -divide_by {25} -source [get_pins {MSS_SUBSYSTEM_sb_0/CCC_0/CLK0_PAD_INST:Y}]  [get_pins {MSS_SUBSYSTEM_sb_0/CCC_0/CCC_INST:GL0}] 
...
set_clock_groups -asynchronous -group [get_clocks {spi_chanctrl_Z19|un5_resetn_rx_inferred_clock}]
